...
def test_process_bank_search(transactions: list[dict], search_word: str, expected: list[dict]) -> None:
...
def test_process_bank_operations(transactions: list[dict], categories: list[str], expected: dict) -> None:
