...
@pytest.mark.parametrize("account_information, expected", [
...
def test_mask_account_card(account_information, expected):
...
@pytest.mark.parametrize('date_another_format, expected', [
...
def test_get_date(date_another_format, expected):
